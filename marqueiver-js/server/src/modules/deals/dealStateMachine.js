 ...
 *   → submitted → (revision → in_progress)×3 → completed
 *
 * Plus:
...
/**
 * Included revision rounds when the terms do not name a number.
 *
 * Re-exported from the Deal model so the schema default, this fallback and the
 * enforcement below cannot drift apart. They had: the schema said 1, this said
 * 2, and the agreed requirement is 3.
 */
export const DEFAULT_REVISION_ROUNDS = INCLUDED_REVISIONS;
