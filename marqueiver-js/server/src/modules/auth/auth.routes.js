...
/**
 * Sign out. Authenticated, because it revokes the caller's own sessions and we
 * need to know whose — an unauthenticated logout taking a user id in the body
 * would let anyone sign anyone else out.
 */
