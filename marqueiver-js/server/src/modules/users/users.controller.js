...
export const getUploadUrlSchema = z.object({
    ...
    purpose: z.enum(['brand-logo', 'portfolio', 'verification', 'avatar', 'banner', 'campaign', 'application', 'message', 'deliverable']).default('portfolio'),
});
export const getLogoUploadUrl = catchAsync(async (req, res) => {
    ...
    const folder = purpose === 'brand-logo' ? 'brand-logos'
        ...
        : purpose === 'deliverable' ? 'deliverables'
        : purpose === 'message' ? 'messages'
        : 'portfolio';
