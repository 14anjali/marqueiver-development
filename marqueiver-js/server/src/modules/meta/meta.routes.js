...
import { platformStats } from './platformStats.controller.js';
 ...
 *
 * Unauthenticated because it is the first thing an anonymous visitor sees, and
 * it returns four whole-platform aggregates that identify nobody. Cached in
 * process for five minutes (see the controller), so the rate limit here is
 * about protecting the instance rather than the database.
 */
router.get(
    '/platform/stats',
