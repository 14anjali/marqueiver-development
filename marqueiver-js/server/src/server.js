...
import { assertPaymentsSafeToBoot } from './services/cashfree.service.js';
async function main() {
    // Before anything else, and before the port is bound: a production server
    // that would silently take mock payments must fail the deploy, not the
    // first brand's escrow. See cashfree.service.js.
    assertPaymentsSafeToBoot();
