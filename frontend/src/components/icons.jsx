...
export const Platform = ({ name, className = 'w-4 h-4' }) => {
  const map = {
    ...
    facebook: <svg viewBox="0 0 24 24" className={className}><rect x="2" y="2" width="20" height="20" rx="5" fill="#1877F2" /><path d="M15.4 12.6h-2v6.9h-2.9v-6.9H9v-2.5h1.5V8.6c0-1.9 1.1-3 2.9-3 .9 0 1.6.1 1.8.1v2.1h-1.2c-.9 0-1.1.4-1.1 1.1v1.2h2.3z" fill="#fff" /></svg>,
...
// Escrow / locked-terms marker. Used wherever money is held.
export const Lock = (p) => <S {...p}><rect x="4" y="10" width="16" height="10" rx="2" /><path d="M8 10V7a4 4 0 0 1 8 0v3" /></S>;
